...
import "./readfreechapter.css"

const Readfreechapter = () => {
  return (
      <div className="book_readfreechapter">
        <div className="book_readfreechapter-container">
            <div className="book_readfreechapter-container_box">
                <div className="primary-heading">Read a free chapter</div>
...
export default Readfreechapter
